namespace IBLeier.VictronEnergy.ModbusTcp
{
    ...
    public class SystemData : IData
    {
        ...
        public double BatteryVoltage
        {
            get
            {
                return Fields[(int)FieldIndex.BatteryVoltage] / SystemData.Scalefactor100;
            }
        }
        ...
        public double BatteryCurrent
        {
            get
            {
                return Fields[(int)FieldIndex.BatteryCurrent] / SystemData.Scalefactor10;
            }
        }
        ...
        public double BatteryTemperature
        {
            get
            {
                return Fields[(int)FieldIndex.BatteryTemperature] / SystemData.Scalefactor10;
            }
        }
        ...
        public double PvVoltage
        {
            get
            {
                return Fields[(int)FieldIndex.PvVoltage] / SystemData.Scalefactor100;
            }
        }
        ...
        public double PvCurrent
        {
            get
            {
                return Fields[(int)FieldIndex.PvCurrent] / SystemData.Scalefactor10;
            }
        }
        ...
        public double EqualizationTimeRemaining
        {
            get
            {
                return Fields[(int)FieldIndex.EqualizationTimeRemaining] / SystemData.Scalefactor10;
            }
        }
        ...
        public double YieldToday
        {
            get
            {
                return Fields[(int)FieldIndex.YieldToday] / SystemData.Scalefactor10;
            }
        }
        ...
        public double YieldYesterday
        {
            get
            {
                return Fields[(int)FieldIndex.YieldYesterday] / SystemData.Scalefactor10;
            }
        }
        ...
        public double PvPower
        {
            get
            {
                return Fields[(int)FieldIndex.PvPower] / SystemData.Scalefactor10;
            }
        }
        ...
        public double UserYield
        {
            get
            {
                return Fields[(int)FieldIndex.UserYield] / SystemData.Scalefactor10;
            }
        }
