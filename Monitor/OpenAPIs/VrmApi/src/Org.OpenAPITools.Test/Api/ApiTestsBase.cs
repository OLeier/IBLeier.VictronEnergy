...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class ApiTestsBase
    {
        ...
        public ApiTestsBase(string[] args)
        {
            ...
            //_host = Host.CreateApplicationBuilder(args).Build();
            ...
            bool defaultProxyEnabled = config.GetValue<bool>("HttpClient:DefaultProxy:Enabled");
            string? defaultProxyAddress = config.GetValue<string>("HttpClient:DefaultProxy:Address");

            if (defaultProxyEnabled && defaultProxyAddress != null)
            {
                HttpClient.DefaultProxy = new WebProxy(defaultProxyAddress, true);
            }
        }
