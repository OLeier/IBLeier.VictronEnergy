...
{
    /// <summary>
    ///  Class for testing StateWidgetsApi
    /// </summary>
    public sealed class StateWidgetsApiTests : ApiTestsBase
    {
        ...
        public async Task InstallationsIdSiteWidgetsBatteryExternalRelayStateCommandAsyncTest()
        {
            ...
            var response = await _instance.InstallationsIdSiteWidgetsBatteryExternalRelayStateCommandAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsBatteryMonitorWarningsAndAlarmsAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsBatteryMonitorWarningsAndAlarmsAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsBatteryRelayStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsBatteryRelayStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsChargerRelayStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsChargerRelayStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsChargerStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsChargerStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsEssBatteryLifeStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsEssBatteryLifeStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsFuelCellStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsFuelCellStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsGatewayRelayStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsGatewayRelayStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsGatewayRelayTwoStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsGatewayRelayTwoStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsGeneratorStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsGeneratorStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsInputStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsInputStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsInverterChargerStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsInverterChargerStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsInverterChargerWarningsAndAlarmsAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsInverterChargerWarningsAndAlarmsAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsInverterStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsInverterStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsMPPTStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsMPPTStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsSolarChargerRelayStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsSolarChargerRelayStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsVeBusStateAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsVeBusStateAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
        ...
        public async Task InstallationsIdSiteWidgetsVeBusWarningsAndAlarmsAsyncTest()
        {
            ...
            Client.Option<int> start = default!;
            Client.Option<int> end = default!;
            var response = await _instance.InstallationsIdSiteWidgetsVeBusWarningsAndAlarmsAsync(xAuthorization, idSite, instance, start, end);
            var model = response.Ok();
            Assert.IsType<InstallationsIdSiteWidgetsGeneratorState200Response>(model);
        }
    }
