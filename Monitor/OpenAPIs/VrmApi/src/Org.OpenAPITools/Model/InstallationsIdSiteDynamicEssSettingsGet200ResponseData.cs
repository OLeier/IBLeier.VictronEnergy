...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class InstallationsIdSiteDynamicEssSettingsGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallationsIdSiteDynamicEssSettingsGet200ResponseData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstallationsIdSiteDynamicEssSettingsGet200ResponseData {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InstallationsIdSiteDynamicEssSettingsGet200ResponseData" />
    /// </summary>
    public class InstallationsIdSiteDynamicEssSettingsGet200ResponseDataJsonConverter : JsonConverter<InstallationsIdSiteDynamicEssSettingsGet200ResponseData>
    {
        /// <summary>
        /// Deserializes json to <see cref="InstallationsIdSiteDynamicEssSettingsGet200ResponseData" />
        /// </summary>
        ...
        public override InstallationsIdSiteDynamicEssSettingsGet200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryFlowRestrictionEnum?> batteryFlowRestriction = default;
            Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceTypeEnum?> buyPriceType = default;
            Option<decimal?> chargePower = default;
            Option<decimal?> dischargePower = default;
            Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.GridSellEnum?> gridSell = default;
            Option<bool?> isOn = default;
            Option<decimal?> maxPowerFromGrid = default;
            Option<decimal?> maxPowerToGrid = default;
            Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceTypeEnum?> sellPriceType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "batteryFlowRestriction":
                            ...
                            if (batteryFlowRestrictionRawValue != null)
                                batteryFlowRestriction = new Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryFlowRestrictionEnum?>(InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryFlowRestrictionEnumFromStringOrDefault(batteryFlowRestrictionRawValue));
                            break;
                        case "buyPriceType":
                            buyPriceType = new Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceTypeEnum?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceTypeEnum?)null : (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceTypeEnum)utf8JsonReader.GetInt32());
                            break;
                        case "chargePower":
                        ...
                        case "dischargePower":
                            ...
                            break;
                        case "gridSell":
                            gridSell = new Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.GridSellEnum?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.GridSellEnum?)null : (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.GridSellEnum)utf8JsonReader.GetInt32());
                            break;
                        case "isOn":
                        ...
                        case "maxPowerToGrid":
                            ...
                            break;
                        case "sellPriceType":
                            sellPriceType = new Option<InstallationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceTypeEnum?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceTypeEnum?)null : (InstallationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceTypeEnum)utf8JsonReader.GetInt32());
                            break;
                        case "batteryPrice":
            ...
            if (!batteryCapacity.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(batteryCapacity));

            if (!batteryCosts.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(batteryCosts));

            if (!batteryFlowRestriction.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(batteryFlowRestriction));

            if (!buyPriceType.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(buyPriceType));

            if (!chargePower.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(chargePower));

            if (!dischargePower.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(dischargePower));

            if (!gridSell.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(gridSell));

            if (!isOn.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(isOn));

            if (!maxPowerFromGrid.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(maxPowerFromGrid));

            if (!maxPowerToGrid.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(maxPowerToGrid));

            if (!sellPriceType.IsSet)
                throw new ArgumentException("Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.", nameof(sellPriceType));

            if (batteryCapacity.IsSet && batteryCapacity.Value == null)
                throw new ArgumentNullException(nameof(batteryCapacity), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (batteryCosts.IsSet && batteryCosts.Value == null)
                throw new ArgumentNullException(nameof(batteryCosts), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (batteryFlowRestriction.IsSet && batteryFlowRestriction.Value == null)
                throw new ArgumentNullException(nameof(batteryFlowRestriction), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (buyPriceType.IsSet && buyPriceType.Value == null)
                throw new ArgumentNullException(nameof(buyPriceType), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (chargePower.IsSet && chargePower.Value == null)
                throw new ArgumentNullException(nameof(chargePower), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (dischargePower.IsSet && dischargePower.Value == null)
                throw new ArgumentNullException(nameof(dischargePower), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (gridSell.IsSet && gridSell.Value == null)
                throw new ArgumentNullException(nameof(gridSell), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (isOn.IsSet && isOn.Value == null)
                throw new ArgumentNullException(nameof(isOn), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (maxPowerFromGrid.IsSet && maxPowerFromGrid.Value == null)
                throw new ArgumentNullException(nameof(maxPowerFromGrid), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (maxPowerToGrid.IsSet && maxPowerToGrid.Value == null)
                throw new ArgumentNullException(nameof(maxPowerToGrid), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (sellPriceType.IsSet && sellPriceType.Value == null)
                throw new ArgumentNullException(nameof(sellPriceType), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (batteryPrice.IsSet && batteryPrice.Value == null)
                throw new ArgumentNullException(nameof(batteryPrice), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (buyEnergyProviderId.IsSet && buyEnergyProviderId.Value == null)
                throw new ArgumentNullException(nameof(buyEnergyProviderId), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (buyPriceFormula.IsSet && buyPriceFormula.Value == null)
                throw new ArgumentNullException(nameof(buyPriceFormula), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (buyPriceSchedule.IsSet && buyPriceSchedule.Value == null)
                throw new ArgumentNullException(nameof(buyPriceSchedule), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (idBiddingZone.IsSet && idBiddingZone.Value == null)
                throw new ArgumentNullException(nameof(idBiddingZone), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (isDessSocDifferent.IsSet && isDessSocDifferent.Value == null)
                throw new ArgumentNullException(nameof(isDessSocDifferent), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (isGreenModeOn.IsSet && isGreenModeOn.Value == null)
                throw new ArgumentNullException(nameof(isGreenModeOn), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (sellEnergyProviderId.IsSet && sellEnergyProviderId.Value == null)
                throw new ArgumentNullException(nameof(sellEnergyProviderId), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (sellPriceSchedule.IsSet && sellPriceSchedule.Value == null)
                throw new ArgumentNullException(nameof(sellPriceSchedule), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (sellPriceFormula.IsSet && sellPriceFormula.Value == null)
                throw new ArgumentNullException(nameof(sellPriceFormula), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (isPeriodicFullChargeOn.IsSet && isPeriodicFullChargeOn.Value == null)
                throw new ArgumentNullException(nameof(isPeriodicFullChargeOn), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (periodicFullChargeDuration.IsSet && periodicFullChargeDuration.Value == null)
                throw new ArgumentNullException(nameof(periodicFullChargeDuration), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (periodicFullChargeInterval.IsSet && periodicFullChargeInterval.Value == null)
                throw new ArgumentNullException(nameof(periodicFullChargeInterval), "Property is not nullable for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            return new InstallationsIdSiteDynamicEssSettingsGet200ResponseData(batteryCapacity.Value!.Value!, batteryCosts.Value!.Value!, batteryFlowRestriction.Value!.Value!, buyPriceType.Value!.Value!, chargePower.Value!.Value!, dischargePower.Value!.Value!, gridSell.Value!.Value!, isOn.Value!.Value!, maxPowerFromGrid.Value!.Value!, maxPowerToGrid.Value!.Value!, sellPriceType.Value!.Value!, batteryPrice, buyEnergyProviderId, buyPriceFormula, buyPriceSchedule, idBiddingZone, isDessSocDifferent, isGreenModeOn, sellEnergyProviderId, sellPriceSchedule, sellPriceFormula, isPeriodicFullChargeOn, periodicFullChargeDuration, periodicFullChargeInterval);
        }

        /// <summary>
        /// Serializes a <see cref="InstallationsIdSiteDynamicEssSettingsGet200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="installationsIdSiteDynamicEssSettingsGet200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InstallationsIdSiteDynamicEssSettingsGet200ResponseData installationsIdSiteDynamicEssSettingsGet200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, installationsIdSiteDynamicEssSettingsGet200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InstallationsIdSiteDynamicEssSettingsGet200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="installationsIdSiteDynamicEssSettingsGet200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InstallationsIdSiteDynamicEssSettingsGet200ResponseData installationsIdSiteDynamicEssSettingsGet200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceFormulaOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceFormula == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceFormula), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceScheduleOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceSchedule == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceSchedule), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceScheduleOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceSchedule == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceSchedule), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceFormulaOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceFormula == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceFormula), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeDurationOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeDuration == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeDuration), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeIntervalOption.IsSet && installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeInterval == null)
                throw new ArgumentNullException(nameof(installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeInterval), "Property is required for class InstallationsIdSiteDynamicEssSettingsGet200ResponseData.");

            writer.WriteNumber("batteryCapacity", installationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryCapacity);

            writer.WriteNumber("batteryCosts", installationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryCosts);

            var batteryFlowRestrictionRawValue = InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryFlowRestrictionEnumToJsonValue(installationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryFlowRestriction);
            writer.WriteString("batteryFlowRestriction", batteryFlowRestrictionRawValue);
            writer.WriteNumber("buyPriceType", InstallationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceTypeEnumToJsonValue(installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceType));

            writer.WriteNumber("chargePower", installationsIdSiteDynamicEssSettingsGet200ResponseData.ChargePower);

            writer.WriteNumber("dischargePower", installationsIdSiteDynamicEssSettingsGet200ResponseData.DischargePower);

            writer.WriteNumber("gridSell", InstallationsIdSiteDynamicEssSettingsGet200ResponseData.GridSellEnumToJsonValue(installationsIdSiteDynamicEssSettingsGet200ResponseData.GridSell));

            writer.WriteBoolean("isOn", installationsIdSiteDynamicEssSettingsGet200ResponseData.IsOn);

            writer.WriteNumber("maxPowerFromGrid", installationsIdSiteDynamicEssSettingsGet200ResponseData.MaxPowerFromGrid);

            writer.WriteNumber("maxPowerToGrid", installationsIdSiteDynamicEssSettingsGet200ResponseData.MaxPowerToGrid);

            writer.WriteNumber("sellPriceType", InstallationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceTypeEnumToJsonValue(installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceType));

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryPriceOption.IsSet)
                writer.WriteNumber("batteryPrice", installationsIdSiteDynamicEssSettingsGet200ResponseData.BatteryPriceOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyEnergyProviderIdOption.IsSet)
                writer.WriteNumber("buyEnergyProviderId", installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyEnergyProviderIdOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceFormulaOption.IsSet)
                writer.WriteString("buyPriceFormula", installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceFormula);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceScheduleOption.IsSet)
            {
                writer.WritePropertyName("buyPriceSchedule");
                JsonSerializer.Serialize(writer, installationsIdSiteDynamicEssSettingsGet200ResponseData.BuyPriceSchedule, jsonSerializerOptions);
            }
            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.IdBiddingZoneOption.IsSet)
                writer.WriteNumber("idBiddingZone", installationsIdSiteDynamicEssSettingsGet200ResponseData.IdBiddingZoneOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.IsDessSocDifferentOption.IsSet)
                writer.WriteBoolean("isDessSocDifferent", installationsIdSiteDynamicEssSettingsGet200ResponseData.IsDessSocDifferentOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.IsGreenModeOnOption.IsSet)
                writer.WriteBoolean("isGreenModeOn", installationsIdSiteDynamicEssSettingsGet200ResponseData.IsGreenModeOnOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.SellEnergyProviderIdOption.IsSet)
                writer.WriteNumber("sellEnergyProviderId", installationsIdSiteDynamicEssSettingsGet200ResponseData.SellEnergyProviderIdOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceScheduleOption.IsSet)
            {
                writer.WritePropertyName("sellPriceSchedule");
                JsonSerializer.Serialize(writer, installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceSchedule, jsonSerializerOptions);
            }
            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceFormulaOption.IsSet)
                writer.WriteString("sellPriceFormula", installationsIdSiteDynamicEssSettingsGet200ResponseData.SellPriceFormula);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.IsPeriodicFullChargeOnOption.IsSet)
                writer.WriteBoolean("isPeriodicFullChargeOn", installationsIdSiteDynamicEssSettingsGet200ResponseData.IsPeriodicFullChargeOnOption.Value!.Value);

            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeDurationOption.IsSet)
            {
                writer.WritePropertyName("periodicFullChargeDuration");
                JsonSerializer.Serialize(writer, installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeDuration, jsonSerializerOptions);
            }
            if (installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeIntervalOption.IsSet)
            {
                writer.WritePropertyName("periodicFullChargeInterval");
                JsonSerializer.Serialize(writer, installationsIdSiteDynamicEssSettingsGet200ResponseData.PeriodicFullChargeInterval, jsonSerializerOptions);
            }
        }
    }
}
