...
namespace Monitor.VrmApi
{
    ...
    public partial class VrmApiClient : ServiceClient<VrmApiClient>, IVrmApiClient
    {
        ...
        {
            BaseUri = new Uri("https://vrmapi.victronenergy.com/v2");
        ...
        public async Task<HttpOperationResponse<InstallationsOKResponse>> InstallationsWithHttpMessagesAsync(string xAuthorization, int idUser, int? extended = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _url = _url.Replace("{idUser}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(idUser, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            if (extended != null)
            {
                _queryParameters.Add(string.Format("extended={0}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(extended, SerializationSettings).Trim('"'))));
            }
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<InstallationsOKResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<SystemOverviewOKResponse>> SystemOverviewWithHttpMessagesAsync(string xAuthorization, int idSite, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _url = _url.Replace("{idSite}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(idSite, SerializationSettings).Trim('"')));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("GET");
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<SystemOverviewOKResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<SolarChargerSummaryOKResponse>> SolarChargerSummaryWithHttpMessagesAsync(string xAuthorization, int idSite, int instance, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _url = _url.Replace("{idSite}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(idSite, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            _queryParameters.Add(string.Format("instance={0}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(instance, SerializationSettings).Trim('"'))));
            if (_queryParameters.Count > 0)
            {
                _url += "?" + string.Join("&", _queryParameters);
            }
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<SolarChargerSummaryOKResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
